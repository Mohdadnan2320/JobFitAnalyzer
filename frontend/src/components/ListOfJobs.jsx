...
const ListOfJobs = () => {
    ...
    useEffect(() => {
      ...
      if (loading) {
        return <div className="text-center text-xl text-gray-500 py-5">Loading job listings...</div>;  // Show loading message while fetching data
      }
      ...
      if (!jobListings.length) {
        return <div className="text-center text-xl text-gray-500 py-5">No job listings available</div>;  // Handle the case when no job listings are found
      }
  return (
